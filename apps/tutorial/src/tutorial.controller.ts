...
export class TutorialController {
  ...
  constructor() {} // @Inject('any_client_id_i_want') private readonly client: ClientKafka, // Ensure the token is correct // private readonly tutorialService: TutorialService,
